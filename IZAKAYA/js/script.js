...
console.log(arr2.join(" , ")); // PRINTING 2D ARRAY
...
console.log(`array join method... with white space... ${arr.join(' ')}`);
// console.log(arr);
...
// FOR EACH LOOP
fruits.forEach(fruits => console.log(`FOREACH with 2D array: ${fruits}`));
