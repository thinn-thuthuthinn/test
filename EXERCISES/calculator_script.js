...
let prevBtn = null; let interim = null;
...
function get_numbers(x, clickedBtn) {
    ...
    if (
        ...
        // interim check: does the user want to continue with the previous operation?
    } else if (operators.includes(x) && operator == null && firstOperand == null) {
        operator = x;
    ...
    //  step 1: the calculator restarts again
